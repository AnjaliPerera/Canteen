...
import l1 from '../../assets/l1.jpg'; // Example lunch image imports
import l2 from '../../assets/l2.jpg';
import l3 from '../../assets/l3.jpg';
import d1 from '../../assets/d1.jpg'; // Adjust path as necessary
...
function FoodSection() {
  ...
  return (
   ...
   <div className="bottom-button">
        <button>Confirm / customize Your Order</button>
      </div>
    </div>
